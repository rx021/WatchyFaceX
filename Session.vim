...
badd +1 README.md
badd +10 WatchyFaceX.ino
badd +1 .gitignore
badd +29 logs.md
badd +1 main.h
badd +14 settings.h
badd +1 Images/media.h
badd +0 Faces/media.h
argglobal
%argdel
...
setlocal foldnestmax=20
setlocal nofoldenable
let s:l = 232 - ((25 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 232
...
exe 'vert 2resize ' . ((&columns * 78 + 79) / 158)
tabnext
edit ~/Downloads/0-CLOUD/WatchyFaceX/Faces/media.h
argglobal
balt ~/Downloads/0-CLOUD/WatchyFaceX/Images/media.h
setlocal foldmethod=indent
setlocal foldexpr=0
setlocal foldmarker={{{,}}}
setlocal foldignore=#
